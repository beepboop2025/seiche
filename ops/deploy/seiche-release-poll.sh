...
REMOTE_GATE_INSTALL_COMMAND="python -m pip install -q ./backend[dev,collectors,postgres] && python -m pip install --disable-pip-version-check --only-binary=:all: --require-hashes -r ops/requirements-social-cards.txt"
