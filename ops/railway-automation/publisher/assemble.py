...
(args.output / "publish-static.yml").write_bytes(
    blob(".github/workflows/publish-static.yml")
)
(args.output / "requirements-social-cards.txt").write_bytes(
    blob("ops/requirements-social-cards.txt")
)
(args.output / "gate-sha256.json").write_text(
    json.dumps(
