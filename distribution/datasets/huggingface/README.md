...
> [distribution ledger](https://github.com/beepboop2025/seiche/blob/v0.13.4/distribution/submissions.csv).**

These metadata links target Seiche `0.13.4`; verify publication status from the
...
[`integrations/datacommons/RIGHTS_AND_SOURCES.md`](https://github.com/beepboop2025/seiche/blob/v0.13.4/integrations/datacommons/RIGHTS_AND_SOURCES.md).
