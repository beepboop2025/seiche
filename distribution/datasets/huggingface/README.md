...
> [distribution ledger](https://github.com/beepboop2025/seiche/blob/v0.13.8/distribution/submissions.csv).**

These metadata links target Seiche `0.13.8`; verify publication status from the
...
[`integrations/datacommons/RIGHTS_AND_SOURCES.md`](https://github.com/beepboop2025/seiche/blob/v0.13.8/integrations/datacommons/RIGHTS_AND_SOURCES.md).
