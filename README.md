...
| **PyPI** | Python package and stdio MCP server (`pip install seiche`) | Repository identity 0.12.1; immutable availability is authoritative only on the linked PyPI project |
