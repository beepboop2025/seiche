...
| **PyPI** | Python package and stdio MCP server (`pip install seiche`) | Repository version 0.12.5; immutable availability is authoritative only on the linked PyPI project |

Version **0.12.5 estuary** batches PostgreSQL history reads
