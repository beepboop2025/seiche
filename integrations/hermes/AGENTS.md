...
Public (fourteen anonymous tools): `latest_article`, `funding_stress_now`,
...
`fx_materials_passage`, `market_workbench`, `research_network` (connected source discovery with
