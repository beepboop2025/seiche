...
Version **0.13.2 estuary** repairs snapshot classification, editorial observation
fidelity and recovery response budgeting. Existing source vintages and forecast
publication-clock requirements remain intact. Versioned commands below apply
...
- the release version, such as `0.13.2`;
- the Git tag, such as `v0.13.2`;
