...
Version **0.13.3 estuary** batches coverage reads while preserving source clocks,
rights filtering, per-market faults and historical record counts. Existing source
vintages and forecast publication-clock requirements remain intact. Versioned commands below apply
...
- the release version, such as `0.13.3`;
- the Git tag, such as `v0.13.3`;
