...
0.13.2 distribution release and fourteen-tool public surface so the release and
...
def test_registry_stdio_package_matches_hosted_surface():
    """The registry card pins the 0.13.2 / fourteen-tool public surface."""
    server = _server_json()
    ...
    assert package["version"] == hosted == "0.13.2"
