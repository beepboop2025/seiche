...
0.12.5 distribution release and fourteen-tool public surface so the release and
...
def test_registry_stdio_package_matches_hosted_surface():
    """The registry card pins the 0.12.5 / fourteen-tool public surface."""
    server = _server_json()
...
def test_money_market_discovery_separates_catalog_from_dated_evidence():
    ...
    assert "Fourteen public MCP tools" in access["authentication"]
