    ...
    health = {
        ...
        "checks": {
            "deep": {
                ...
                "datasets": signed["engineVerifiedObjects"],
...
def test_signed_publication_receipt_has_exact_release_generation():
    ...
    assert receipt == {
        "schemaVersion": "1.0.0",
        "tag": "market-corpus-receipt-corpus-8767ecfcf4f3ca6b",
        "releaseId": "corpus-8767ecfcf4f3ca6b",
        "indexSha256": (
            "c8edf7f4e33f57970ed985c9306bb8708b8cbcfe61db57d2b29c4907456d7f44"
        ),
        "indexArtifactId": (
            "liquilens-engine-public-index-v1:corpus-8767ecfcf4f3ca6b:"
            "c8edf7f4e33f57970ed985c9306bb8708b8cbcfe61db57d2b29c4907456d7f44"
        ),
        "inventorySha256": (
...
def test_publication_receipt_tag_must_target_exact_workflow_head(monkeypatch):
    ...
    assert tag == "market-corpus-receipt-corpus-8767ecfcf4f3ca6b"
    assert gate._market_corpus_publication_receipt(entry)["releaseId"] == (
        "corpus-8767ecfcf4f3ca6b"
    )
...
def test_market_corpus_receipts_bind_deep_health_catalog_and_tools():
    ...
    assert receipt["releaseId"] == "corpus-8767ecfcf4f3ca6b"
...
def test_both_static_publishers_gate_before_their_first_public_write():
    ...
    for workflow in (fast, full):
        ...
        assert "^market-corpus-receipt-corpus-[0-9a-f]{16}$" in workflow
        assert (
