...
export const ENTRIES: Entry[] = [
  ...
  { code: "WB", title: "MARKET WORKBENCH", hint: "funding observations · FX crosses and history · China economic evidence", keywords: "workbench compare currency pairs exchange rates forex structured China Palimpsest annual reserves trade credit export", run: { type: "tab", tab: "WORKBENCH" } },
  { code: "DATA", title: "MARKET ATLAS", hint: "market → instrument → observation · bulk BIS · rights · clocks", keywords: "corpus datasets structured data market atlas evidence provenance license rights bis observations revisions api mcp", run: { type: "tab", tab: "CORPUS" } },
...
const ALIAS_CODES: Record<string, string> = {
  ...
  WORKBENCH: "WB", FXDATA: "WB",
  CORPUS: "DATA", DATASETS: "DATA", EVIDENCE: "DATA", ATLAS: "DATA", OBSERVATIONS: "DATA",
